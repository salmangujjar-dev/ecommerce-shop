...
-- CreateIndex
CREATE UNIQUE INDEX "product_images_productId_primary_key" ON "product_images"("productId", "primary");
...
-- AddForeignKey
ALTER TABLE "products" ADD CONSTRAINT "products_genderId_fkey" FOREIGN KEY ("genderId") REFERENCES "genders"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
